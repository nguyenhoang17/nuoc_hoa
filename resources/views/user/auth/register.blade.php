...
<div class="wrapper">
    ...
    <form class="p-3 mt-3">
        ...
        <div class="form-field d-flex align-items-center">
            <span class="fas fa-key"></span>
            <input type="password" name="password_confirm" id="pwd" placeholder="Xác nhận mật khẩu">
        </div>
        <button style="background-color: #00c054" class="btn btn-success mt-3">Đăng ký</button>
    </form>
    <div class="text-center fs-6">
        <a class="text-success" href="{{route('user.login')}}">Đăng nhập</a>
    </div>
</div>
